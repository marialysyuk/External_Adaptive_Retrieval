...
def need_context_new(sample, with_context_col, without_context_col, need_context_col):
...
# def need_context_train(sample, with_context_col, without_context_col, need_context_col):
#     # if sample[f'KM_{with_context_col}'] > sample[f'KM_{without_context_col}']:
#     #     need_context = 1
#     # else:
#     #     need_context = 0
#     if sample[f"InAccuracy_{without_context_col}"]:
#         need_context = 0
#     elif sample[f"InAccuracy_{with_context_col}"]:
#         need_context = 1
#     else:
#         need_context = 2
#     sample[need_context_col] = need_context
...
# def need_context_test(sample, with_context_col, without_context_col, need_context_col):
#     # if sample[f'KM_{with_context_col}'] > sample[f'KM_{without_context_col}']:
#     #     need_context = 1
#     # else:
#     #     need_context = 0
